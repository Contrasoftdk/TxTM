...
if (count($_POST) > 0) {
  ...
  if ($do_insert) {
    custom_redirect("Location: " . HOME_URL . "/takstzoner.php?action=edit&method=edit&id=" . $id . "&success=1");
  }
}
switch ($method) {
  case 'edit':
    $id   = @$_GET['id'];
    if (!$id) {
      custom_redirect("Location: " . HOME_URL . "/takstzoner.php");
      die();
    }
    break;
...
switch ($action) {
  case 'delete':
    ...
    if ($do_del) {
      custom_redirect("Location: " . HOME_URL . "/takstzoner.php?success=1");
    } else {
      custom_redirect("Location: " . HOME_URL . "/takstzoner.php?error=1&task=delete");
    }
    die();
    break;
  case 'edit':
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="active"><a href="takstzoner.php"><i class="fa fa-bar-chart"></i> <span>Takstzoner</span></a></li>
            ...
            <div class="nav-tabs-custom">
              <ul class="nav nav-tabs">
                <li class="<?php if (!$method || $method == 'index') {
                  ...
                  <a href="<?php echo HOME_URL; ?>/takstzoner.php?method=index">Rediger i takster</a>
                </li>
                <li class="<?php if ($method == 'add') {
                              echo 'active';
                            }; ?>">
                  <a href="<?php echo HOME_URL; ?>/takstzoner.php?method=add">Opret ny takst</a>
                </li>
                <?php if (@$_GET['id']) : ?>
                  <li class="<?php if ($method == 'edit') {
                                echo 'active';
                              }; ?>">
                    <a href="<?php echo HOME_URL; ?>/takstzoner.php?method=edit">Rediger i takst</a>
                  </li>
                <?php endif; ?>
              </ul>
              <div class="tab-content">
                <div class="active tab-pane" id="struck">
                  ...
                  <?php if (!$method || $method == 'index') : ?>
                    <table id="TakstZonerTable" class="table table-bordered table-striped">
                      <thead>
                        <tr>
                          <th>Takst Id</th>
                          <th>Takst Type</th>
                  ...
                  <?php if ($method && $method == 'add' || $method == 'edit') : ?>
                    <form class="form-horizontal" action="" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="startprice" value="<?php echo @$startprice; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="waitprice" value="<?php echo @$waitprice; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="kmprice" value="<?php echo @$kmprice; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="halfhourprice" value="<?php echo @$halfhourprice; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="minimumprice" value="<?php echo @$minimumprice; ?>">
                        </div>
                      </div>
  ...
  <script>
    $(function() {
      ...
      var table1 = $("#TakstZonerTable").DataTable({
        "ajax": {
          "url": "ajax_data_rates.php",
          "type": "POST",
          "data" : myKeyVals
        }
      });
