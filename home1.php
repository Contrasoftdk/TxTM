...
//trips for the last 12 months, there is 2 types of trips (private, business)
 $trips_2_types_sql = "SELECT * FROM trip where tdate > DATE_SUB(now(), INTERVAL 12 MONTH)";
...
$sql1 = "SELECT * FROM trip where tdate = '$today'";
...
$payment_info = $new_payments = array();
...
//info box
  ...
  foreach ($payments as $paymentid => $paymenttype) {
     //cash
    if( $paymentid == 1 ){
      $total = ($cash_private + $cash_business);
      $data_chart4[1] = '
      {
        value: "'.$total.'",
     ...
     //card
    if( $paymentid == 2 ){
      $total = ($credit_private + $credit_business);
                ...
                <div class="col-md-6">
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <div class="row">
                        <label class="col-md-6">Kontant</label>
                        <div class="col-md-6"><?php echo $cash_private;?></div>
                      </div>
                       <div class="row">
                        <label class="col-md-6">Kreditkort</label>
                        <div class="col-md-6"><?php echo $credit_private;?></div>
                      </div>
                      <div class="row">
                        <label class="col-md-6">Total</label>
                        <div class="col-md-6"><?php echo $cash_private + $credit_private; ?></div>
                      </div>
                    </div>
                  </div>
                </div>
