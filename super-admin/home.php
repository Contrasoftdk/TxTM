...
$trips_2_types_sql = "SELECT * FROM trip where business_id = " . $_GET['bid'] . " AND tdate > DATE_SUB(now(), INTERVAL 12 MONTH)";
...
// $today = '2017-01-30';
$today = date('Y-m-d');
$sql1 = "SELECT * FROM trip where business_id = " . $_GET['bid'] . " AND tdate = '$today'";
  ...
  <div class="wrapper">
    <header class="main-header">
      ...
      <a href="home.php" class="logo">
        ...
        <span class="logo-mini"><b>First Transport</b></span>
